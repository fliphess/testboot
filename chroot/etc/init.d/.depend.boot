TARGETS = mountkernfs.sh udev mountdevsubfs.sh resolvconf mountall.sh mountall-bootclean.sh networking mountnfs.sh mountnfs-bootclean.sh hwclock.sh urandom mdadm-raid hostname.sh checkfs.sh checkroot.sh bootlogd procps lvm2 bootmisc.sh udev-mtab kmod checkroot-bootclean.sh mtab.sh screen-cleanup stop-bootlogd-single
...
stop-bootlogd-single: mountall.sh mountall-bootclean.sh udev resolvconf networking mountnfs.sh mountnfs-bootclean.sh hwclock.sh mountkernfs.sh urandom mdadm-raid hostname.sh checkfs.sh mountdevsubfs.sh checkroot.sh bootlogd procps lvm2 bootmisc.sh udev-mtab kmod checkroot-bootclean.sh mtab.sh screen-cleanup
